...
return [
    ...
    "dashboard"                      => "",
    "date"                           => "Date",
    "daily_tip"                      => "Daily register tip",
    "daily_tip_check_receipts"       => "Check receipt printer paper before the lunch rush.",
    "daily_tip_count_drawer"         => "Count the cash drawer before opening the register.",
    "daily_tip_review_discounts"     => "Review active discounts before the first sale.",
    "daily_tip_update_inventory"     => "Update low-stock items before peak checkout hours.",
    "delete"                         => "Delete",
    "det"                            => "details",
